...
registerBlockType('gutenberg-blocks/progress-bar', {
	title: __('Progress Bar'),
	icon: icon,
	category: 'gutenberg-blocks',
	keywords: [__('Progress Bar'), __('Gutenberg Blocks')],
	...
	edit: withState({ editable: 'content' })(function(props) {
		...
		return [
			...
			<div className="gutenberg-blocks-progress-bar">
				<div key={'editable'} className="gutenberg-blocks-progress-bar-text">
					<RichText
						tagName="p"
