 ...
 */
registerBlockType('gutenberg-blocks/button-block', {
	title: __('Buttons'),
	icon: icon,
	category: 'gutenberg-blocks',
	keywords: [__('Button'), __('Buttons'), __('Gutenberg Blocks')],
	attributes: {
		buttonText: {
			type: 'array',
			source: 'children',
			selector: '.gutenberg-blocks-button-block-btn'
		},
		align: {
			type: 'string',
			default: 'center'
	...
	edit: withState({ editable: 'content' })(function(props) {
		...
		return [
			...
			<div key={'editable'} className={props.className}>
				<div
					className={'gutenberg-blocks-button-container' + ' align-button-' + align}
				>
					<RichText
						...
						className={'gutenberg-blocks-button-block-btn' + ' gutenberg-blocks-button-' + size}
						onChange={value =>
				...
				<div className="gutenberg_blocks_button_url_input">
					{focus && (
						<form
							key={'form-link'}
							onSubmit={event => event.preventDefault()}
							className={`editor-format-toolbar__link-modal-line gutenberg_blocks_button_input_box flex-container`}
						>
							<div
								style={{
									position: 'relative',
